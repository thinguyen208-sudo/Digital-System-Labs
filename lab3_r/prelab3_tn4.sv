module prelab3_tn4 (
    ...
    input  logic [2:0] Final_exp,   // Original exponent from larger operand
    output logic [3:0] Result_fract, // 4-bit normalized fraction
    output logic [2:0] Result_exp    // 3-bit normalized exponent
);
